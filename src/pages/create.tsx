...
export default function Home() {
  ...
  const { race, dndClass, abilityScores, description } = characterStore((state) => state);
  const { background, details, physical, personal, notes }: CharacterDescription = description;
